...
"""
A modified version of SAC adaptive fast for fault tolerant environment.
...
def sac_fault(env_fn, hidden_sizes=[256, 256], seed=0,
    ...
    Args:
        ...
        randomize: whether to randomize the model. If set to false, the environment will use the default ant model.

        joint_error: range of error for the joint error. e.g. : 0.1 means the range of error for the robot is 10%,
                    that its joint length will be between 90% - 100% of the original length.
